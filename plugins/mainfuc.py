...
async def start(client,message):
	...
	await message.reply_text("Hello iam Pdisk Uploader Bot\nMade with love by @king072326",reply_to_message_id = message.message_id,reply_markup=InlineKeyboardMarkup([ [ InlineKeyboardButton("Support 🇮🇳" ,url="https://t.me/allnewmovieintime") ], [InlineKeyboardButton("Subscribe 🧐", url="https://t.me/allnewmovieintime") ]  ]  ) 
        )
